...
class EthernetDissector(Dissector):
    ...
    def verificar_crc32_ethernet(self, packet):
        ...
        calculated_crc = binascii.crc32(datosParaElCalculo,0x04C11DB7) & 0xFFFFFFFF  # Calcula crc sobre el fragmento sin los últimos 4 bytes (FCS) ni los primeros 8 bytes
    ...
    #     calculated_crc = binascii.crc32(raw_data[:longitud_sin_fcs],0xFFFFFFFF ) & 0x04C11DB7
    #
    #
